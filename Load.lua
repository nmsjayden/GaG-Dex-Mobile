...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			rawAPI = rawAPI or game:GetService("HttpService"):JSONDecode("{}")
	...
	if Main.Elevated then
		-- Stub fallback value to prevent errors if RobloxVersion is accessed later
		Main.RobloxVersion = "FakeVersion-1.0.0"
	end
